...
from KillerXRobot.modules import ALL_MODULES
from KillerXRobot.modules.helper_funcs.chat_status import is_user_admin
from KillerXRobot.modules.helper_funcs.decorators import kigcmd, kigcallback, kigmsg
from KillerXRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KillerXRobot.modules." + module_name)
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"KillerX started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        KillerXINIT.bot_id = dispatcher.bot.id
        KillerXINIT.bot_username = dispatcher.bot.username
        KillerXINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    log.info("[KILLERX] Successfully loaded modules: " + str(ALL_MODULES))
