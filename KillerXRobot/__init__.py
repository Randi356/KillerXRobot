...
log.info("[KILLERX] KillerX is starting. | An Eagle Union Project. | Licensed under GPLv3.")
log.info("[KILLERX] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[KILLERX] Project maintained by: github.com/Randi356 (t.me/FFmpegNotInstalled)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[RENDY] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)
...
class KillerXINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "KillerX" #placeholder
        self.bot_username = "KillerXRobot" #placeholder
...
KInit = KillerXINIT(parser=kigconfig)
...
from KillerXRobot.modules.sql import SESSION
...
from KillerXRobot.modules.helper_funcs.handlers import CustomCommandHandler
