...
import KillerXRobot.modules.sql.notes_sql as sql
from KillerXRobot import dispatcher, log as LOGGER, OWNER_ID
from KillerXRobot.__main__ import DATA_IMPORT
from KillerXRobot.modules.helper_funcs.alternate import typing_action
from KillerXRobot.modules.helper_funcs.decorators import kigcmd
from KillerXRobot.modules.rules import get_rules
import KillerXRobot.modules.sql.rules_sql as rulessql
from KillerXRobot.modules.language import gs
from KillerXRobot.modules.sql import warns_sql as warnssql
import KillerXRobot.modules.sql.blacklist_sql as blacklistsql
from KillerXRobot.modules.sql import disable_sql as disabledsql

from KillerXRobot.modules.sql import cust_filters_sql as filtersql
import KillerXRobot.modules.sql.welcome_sql as welcsql
import KillerXRobot.modules.sql.locks_sql as locksql
from KillerXRobot.modules.connection import connected
...
def export_data(update, context):  # sourcery no-metrics
    ...
    # Warns (TODO)
    warns = warnssql.get_warns(chat_id, pass_args=True)
    # Backing up
    backup[chat_id] = {
        "bot": context.bot.id,
        "hashes": {
