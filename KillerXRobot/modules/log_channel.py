...
if is_module_loaded(FILENAME):
    ...
    from KillerXRobot import GBAN_LOGS, log, dispatcher
    from KillerXRobot.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
    from KillerXRobot.modules.sql import log_channel_sql as sql
