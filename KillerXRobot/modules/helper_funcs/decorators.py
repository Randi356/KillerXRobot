from KillerXRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from telegram.ext import CommandHandler, MessageHandler, CallbackQueryHandler, InlineQueryHandler
from telegram.ext.filters import BaseFilter, Filters
from KillerXRobot import dispatcher as d, log
from typing import Optional, Union, List


class KillerXTelegramHandler:
    def __init__(self, d):
        self._dispatcher = d
...
kigcmd = KillerXTelegramHandler(d).command
kigmsg = KillerXTelegramHandler(d).message
kigcallback = KillerXTelegramHandler(d).callbackquery
kiginline = KillerXTelegramHandler(d).inlinequery
