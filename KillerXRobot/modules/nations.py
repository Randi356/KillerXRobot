...
from KillerXRobot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from KillerXRobot.modules.helper_funcs.extraction import extract_user
from KillerXRobot.modules.log_channel import gloggable
from KillerXRobot.modules.sql import nation_sql as sql
...
nations = """ Hito has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Hito is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Hito.
\n*Sakuras* - Have access go globally ban users across hito.
...
\n*Disclaimer*: The Nation levels in Hito are there for troubleshooting, support, banning potential scammers.
