...
from KillerXRobot.modules.helper_funcs.string_handling import markdown_parser

import KillerXRobot.modules.sql.feds_sql as sql

from KillerXRobot.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
from KillerXRobot.modules.helper_funcs.decorators import kigcmd, kigcallback
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "KillerXRobot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="KillerXRobot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "KillerXRobot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="KillerXRobot_fbanned_users.csv",
